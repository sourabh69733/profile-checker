"""
LLM prompts for resume parsing and classification.
"""
...
# Classification prompt for parsed resumes
RESUME_CLASSIFY_PROMPT = """
You are an expert HR analyst. Analyze the parsed resume data and provide a detailed classification.

=== CLASSIFICATION RULES ===

EXPERIENCE LEVEL:
- FRESHER: Less than 12 months of FULL-TIME work experience (internships do NOT count)
- EXPERIENCED: 12 or more months of FULL-TIME work experience
- Contract and freelance work DOES count toward professional experience
...
| Flag | Apply When | DO NOT Apply When |
|------|------------|-------------------|
| career_gap | Gap of 6+ months between jobs | Jobs are continuous or gap < 6 months |
| career_switch | Changed tech domain significantly | Stayed in same/similar domain |
| overqualified | 5+ years experience AND senior titles | Less than 5 years OR no senior titles |
| underqualified | Skills don't match experience level | Skills reasonably match experience |
| frequent_job_changes | 3+ jobs in 2 years | Normal tenure (1+ year per job) |
| no_formal_education | Education section is EMPTY | Has ANY degree or institution listed |
| strong_projects | Notable projects with impact | Basic/academic projects only |
| certification_heavy | 3+ relevant certifications | Less than 3 certifications |
| internship_only | ONLY internships, zero full-time | Has at least 1 full-time job |
| leadership_experience | Lead/Manager/Director titles | No leadership titles |
| startup_experience | Worked at startups | Only established companies |
| faang_experience | Worked at Google/Meta/Amazon/Apple/Netflix/Microsoft | No top-tier company |
| recent_graduate | Graduated within last 12 months | Graduated more than 12 months ago |
| skill_mismatch | Skills contradict job titles | Skills align with titles |
...
{{
    ...
    "summary": "One sentence verdict about this candidate."
}}
